...
void option_save_btn_action(lv_event_t *e)
{
  if (isOptionsDirty())
  {
    afterAlarmAction = COLDSENSES_ACTION_SAVE_CONFIRM;
...
void cancel_save_btn_action(lv_event_t *e)
{
  if (isOptionsDirty())
  {
    afterAlarmAction = COLDSENSES_ACTION_SAVE_CANCEL;
...
{
  afterAlarmAction = COLDSENSES_ACTION_INPUT_CONFIRM;
...
{
  afterAlarmAction = COLDSENSES_ACTION_INPUT_CANCEL;
...
{
  afterAlarmAction = COLDSENSES_ACTION_INPUT_RESET;
